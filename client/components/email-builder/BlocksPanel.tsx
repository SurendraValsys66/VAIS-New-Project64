  ...
  return (
    <div className="flex flex-col h-full bg-white border-r border-gray-200">
      <Tabs defaultValue="blocks" className="flex flex-col h-full">
        <TabsList className="w-full rounded-none border-b border-gray-200 bg-white p-0">
          <TabsTrigger
            value="blocks"
            className="flex-1 rounded-none border-0 data-[state=active]:border-b-2 data-[state=active]:border-valasys-orange"
          >
            Blocks
          </TabsTrigger>
          <TabsTrigger
